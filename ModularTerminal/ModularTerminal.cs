...
namespace ModularTerminal
{
    class ModularTerminal
    {
        ...
        {
            var first = new Input<string>("I'll let you enter the first item of the menu: ").Result; // Get the user's string input to use later
            ...
            new Exit(); /* http://i.imgur.com/klYQmwL.jpg the text message sent by the Caddy, a corrupt officer working in anti-corruption, before the armed
                         ...
                         * 
                         * Him and his crew were later fatally shot by a high caliber sniper rifle - wielded by none other than the partner of the officer he implicated
                         * as being the Caddy in his place.
                         * 
                         * His dying declaration helped them catch a bunch of pedos, so that was cool.
                         * 
                         * Rest in peace
                         */
        }
